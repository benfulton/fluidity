...
PETSC_LINK_LIBS=`make -s -f petsc_makefile_old getlinklibs 2> /dev/null || make -s -f petsc_makefile getlinklibs 2>/dev/null || make -s -f petsc_319_makefile getlinklibs`
...
PETSC_INCLUDE_FLAGS=`make -s -f petsc_makefile_old getincludedirs 2> /dev/null || make -s -f petsc_makefile getincludedirs 2>/dev/null || make -s -f petsc_319_makefile getincludedirs`
...
if test "0$PETSC_VERSION_MAJOR" -ge 3 -a "0$PETSC_VERSION_MINOR" -ge 19; then
  AC_DEFINE(PETSC_NULL_PTR_NAME,PETSC_NULLPTR,[Name of PETSc's null pointer type])
else
  AC_DEFINE(PETSC_NULL_PTR_NAME,PETSC_NULL,[Name of PETSc's null pointer type])
fi
